...
public class OrebfuscatorProximityConfig implements ProximityConfig {
	...
	private short defaultHideCondition;
	...
	protected void serialize(ConfigurationSection section) {
		...
		boolean above = section.getBoolean("above", true);
		this.defaultHideCondition = HideCondition.create(y, above);
		if (section.getBoolean("useBlockBelow", false)) {
	...
	protected void deserialize(ConfigurationSection section) {
		...
		section.set("y", HideCondition.getY(this.defaultHideCondition));
		section.set("above", HideCondition.getAbove(this.defaultHideCondition));
		section.set("useBlockBelow", BlockMask.isUseBlockBelowSet(this.defaultHideCondition));
