...
public final class NamespacedKey {
  ...
  /**
   * Get a NamespacedKey from the supplied string with a default namespace if a namespace is not defined. This is a
   * utility method meant to fetch a NamespacedKey from user input. Please note that casing does matter and any instance
   * of uppercase characters will be considered invalid. The input contract is as follows:
   *
   * <pre>
   ...
   * @param defaultNamespace the default namespace to use if none was supplied. If null, the {@code minecraft} namespace
